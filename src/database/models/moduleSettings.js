...
const SCHEMAS = {
  ...
  levels: {
    ...
    tagRewardEnabled: [false, 'bool'],
    tagRoleId: ['', 'text:32'],
  },
  moderation: {
    enabled: [false, 'bool'],
    muteRoleIds: ['', 'text:600'],
    warnRoleIds: ['', 'text:600'],
    kickRoleIds: ['', 'text:600'],
    banRoleIds: ['', 'text:600'],
    ignoredRoleIds: ['', 'text:600'],
    dmOnAction: [true, 'bool'],
    warnLimitEnabled: [false, 'bool'],
    warnLimit: [3, 'int:1:50'],
    warnLimitAction: ['timeout', 'enum:timeout|kick|ban'],
    warnLimitTimeoutMinutes: [60, 'int:1:40320'],
  },
  welcome: {
    joinTitle: ['', 'text:256'],
    joinFooter: ['', 'text:256'],
    joinImageUrl: ['', 'text:500'],
    joinThumbnail: [true, 'bool'],
    joinAuthor: [true, 'bool'],
    joinTimestamp: [true, 'bool'],
    leaveEmbed: [false, 'bool'],
    leaveTitle: ['', 'text:256'],
    leaveFooter: ['', 'text:256'],
    leaveColor: ['', 'text:7'],
  ...
  stats: {
    enabled: [false, 'bool'],
    categoryId: ['', 'text:32'],
    showMembers: [true, 'bool'],
    showBoosts: [false, 'bool'],
    showBots: [false, 'bool'],
    showRoles: [false, 'bool'],
    membersChannelId: ['', 'text:32'],
    boostsChannelId: ['', 'text:32'],
    botsChannelId: ['', 'text:32'],
    rolesChannelId: ['', 'text:32'],
  },
  verification: {
    enabled: [false, 'bool'],
    channelId: ['', 'text:32'],
    roleId: ['', 'text:32'],
    removeRoleId: ['', 'text:32'],
    title: ['✅ Verifizierung', 'text:256'],
    message: ['Klicke auf den Button, um dich zu verifizieren und Zugriff auf den Server zu erhalten.', 'text:1500'],
    buttonLabel: ['Verifizieren', 'text:40'],
    messageId: ['', 'text:32'],
  },
  rules: {
    enabled: [false, 'bool'],
    channelId: ['', 'text:32'],
    title: ['📜 Server-Regeln', 'text:256'],
    intro: ['Willkommen auf dem Server! Damit alles reibungslos und angenehm bleibt, haben wir ein paar einfache Regeln. Klicke unten auf einen Bereich, um die passenden Regeln zu lesen.', 'text:2000'],
    color: ['', 'text:7'],
    imageUrl: ['', 'text:500'],
    footer: ['', 'text:256'],
    noticeTitle: ['Hinweis des Teams', 'text:256'],
    noticeText: ['Das Serverteam hat das letzte Wort. Maßnahmen wie Stummschaltungen oder Sperren können auch bei nicht aufgeführten Fällen verhängt werden.', 'text:1000'],
    messageId: ['', 'text:32'],
    messageChannelId: ['', 'text:32'],
  },
  voicesupport: {
    enabled: [false, 'bool'],
    waitingChannelId: ['', 'text:32'],
    notifyChannelId: ['', 'text:32'],
    roleId: ['', 'text:32'],
  },
  clubs: {
    enabled: [false, 'bool'],
